...
下跌3天，不同止盈标准m下收益的对比
"""
def get_data_analysis4_3(stock_code, stock_name, test_start, test_end):
    ...
    list_n3 = [round(account_profits_0[-1], 2),
    ...
    plt.title(stock_code + '(n=3, m=0~1.07)' + t1 + '--' + t2)
    ...
    plt.savefig('/home/cdd/Desktop/Scraping/stocks/stock_analysis/stock_data2/'
                + stock_code + stock_name + t1 + '--' + t2 + '(n=3)' + '.png')
    plt.show()
